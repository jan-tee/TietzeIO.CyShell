...
```
Get-CylancePackage [-Package <CyPackageMetaData>] [-Api <ApiConnectionHandle>] [<CommonParameters>]
```
...
### TietzeIO.CyAPI.Entities.Optics.CyPackageMetaData

## OUTPUTS

### TietzeIO.CyAPI.Entities.Optics.CyPackage
