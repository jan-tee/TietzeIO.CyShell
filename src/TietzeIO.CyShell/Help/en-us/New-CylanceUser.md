...
```
New-CylanceUser -FirstName <String> -LastName <String> -Email <String> -Role <String> [-ZoneRights <String>]
...
Parameter Sets: (All)
Aliases:
Accepted values: Administrator, User, ZoneManager
...
### TietzeIO.CyAPI.Entities.CyUser
