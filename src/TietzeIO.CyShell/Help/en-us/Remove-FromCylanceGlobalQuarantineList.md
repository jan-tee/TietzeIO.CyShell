...
# Remove-FromCylanceGlobalQuarantineList
...
```
Remove-FromCylanceGlobalQuarantineList -Threat <PSObject> [-Api <ApiConnectionHandle>] [<CommonParameters>]
```
...
### TietzeIO.CyAPI.Rest.CyRestRemoveFromGlobalList
