...
```
Select-CylanceThreatDevices -Threat <CyThreatDevice> [-Api <ApiConnectionHandle>] [-Classification <String[]>]
 [-SubClassification <String[]>] [-Name <String[]>] [-LiteralPath <String[]>] [<CommonParameters>]
```
