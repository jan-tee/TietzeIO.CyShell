...
# Invoke-CylanceArtifactAnalysis
...
```
Invoke-CylanceArtifactAnalysis [-CreateExceptions] [-PerVersionStats] [-Api <ApiConnectionHandle>] [-WhatIf]
...
### -PerVersionStats
{{ Fill PerVersionStats Description }}
...
### TietzeIO.CyAPI.Analytics.DetectionAnalyzer+DetectionRuleStats
