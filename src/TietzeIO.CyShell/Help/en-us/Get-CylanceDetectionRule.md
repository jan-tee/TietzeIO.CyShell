...
```
Get-CylanceDetectionRule -Rule <CyDetectionRuleMetaData> [-Api <ApiConnectionHandle>] [<CommonParameters>]
```
...
### TietzeIO.CyAPI.Entities.Optics.CyDetectionRuleMetaData
