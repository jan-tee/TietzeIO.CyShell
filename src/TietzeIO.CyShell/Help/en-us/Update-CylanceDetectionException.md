...
# Update-CylanceDetectionException
...
```
Update-CylanceDetectionException -DetectionException <CyDetectionException> [-Api <ApiConnectionHandle>]
 [<CommonParameters>]
```
