...
```
Remove-CylancePolicy -Policy <CyPolicyMinimalMetaData> [-Api <ApiConnectionHandle>] [<CommonParameters>]
```
...
### TietzeIO.CyAPI.Entities.Policy.CyPolicyMinimalMetaData
